...
if ($search) {
    ...
    $search_query = "WHERE customer_name LIKE '%$search%' OR awbnumber LIKE '%$search%' OR product_id LIKE '%$search%' AND address LIKE 'Pasay%'";
} else {
    $search_query = "WHERE address LIKE 'Pasay%'";
}
...
<section id="manifest">
    <h2 class="text-center p-5">List of Parcel in Pasay</h2>
    <form action="" method="POST">

        <!-- Search Form -->
<form method="post" action="pasay.php">
