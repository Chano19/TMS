...
if (!isset($_SESSION['email']) || $_SESSION['hub'] != 'Calamba' || $_SESSION['role'] != 'Rider') {
...
<body>
  <div class="wrapper sidebar">
    ...
    <a class="active" href="riderclmb_profile.php">Profile</a>
  ...
  <div class="container p-5">
    <div class="row">
      <div class="col-md-3">
       <img src="images/boyicon.jpg" class="img-fluid rounded-pill p-3 mt-4" width="300px" alt="CRC">
      </div>
      <div class="col-md-4">
