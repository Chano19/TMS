...
$sql = "SELECT id, awbnumber, price, datetime, status FROM manifests WHERE hub='Makati' AND status='Delivered'";
$result = $conn->query($sql);

// Calculate total amount based on the same conditions
$total_sql = "SELECT SUM(price) AS total_amount FROM manifests WHERE hub='Makati' AND status='Delivered'";
...
<body>
  <div class="sidebar">
    ...
    <a href="ridermkt_order.php">Order</a>
    <a class="active" href="ridermkt_remittance.php">Remittance</a>
