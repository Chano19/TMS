...
FROM login INNER JOIN manifests ON login.name = manifests.rider_name WHERE manifests.hub='Pasay' AND manifests.status='Delivered';";
...
<body>
  <div class="sidebar">
    ...
    <a href="pasayhub.php"><i class="fas fa-home"></i> Home</a>
    ...
    <a class="active mt-3" href="pasay_remit.php"><i class="fas fa-user-cog"></i> Remittance</a>
