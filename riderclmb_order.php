...
if ($search) {
	...
	$search_query = "WHERE hub='Calamba' && status='Assigned' || status='Delivered' || status='Cancel - First Attempt' || status='Cancel - Second Attempt' || status='Cancel - Third Attempt' || status='Return'";
}
...
<body>
  <div class="wrapper sidebar">
    ...
    <a href="riderclmb_profile.php">Profile</a>
    <a class="active" href="riderclmb_order.php">Order</a>
	<a href="riderclmb_remittance.php">Remittance</a>
  ...
  <section id="order">
    <div class="content">
      ...
      <!-- Search Form -->
      <form method="post" action="riderclmb_order.php">
        ...
        if ($result && $result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
						...
						<td>" . $row["datetime"]. "</td>
						<td>
							<form method='post' action='riderclmb_order.php' enctype='multipart/form-data'>
