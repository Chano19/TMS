...
<body>
  ...
  <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="card">
            <button type="button" class="ords btn btn-info active" onclick="location.href='batangashuborders.php'">
        ...
        <div class="col-md-6">
          <div class="card">
            <button type="button" class="rides btn btn-info" onclick="location.href='batangasrider.php'">
