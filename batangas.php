...
if ($search) {
    ...
    $search_query = "WHERE customer_name LIKE '%$search%' OR awbnumber LIKE '%$search%' OR product_id LIKE '%$search%' AND address LIKE 'Batangas%'";
} else {
...
<section id="manifest">
    <h2 class="text-center p-5">List of Parcel in Batangas</h2>
    <form action="" method="POST">

        <!-- Search Form -->
<form method="post" action="batangas.php">
