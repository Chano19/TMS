...
if ($search) {
	...
	$search_query = "WHERE address LIKE 'Pasay' && status='Out for Delivery'";
}
...
<body>
  <div class="sidebar">
    ...
    <a class="active" href="pasay_assign.php"><i class="fas fa-user-cog"></i> Assign Riders</a>
  ...
  <div class="content">
    ...
    <form action="" method="POST">
      <div class="table-responsive">
        ...
        <!-- Search Form -->
<form method="post" action="pasay_assign.php">
