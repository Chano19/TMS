...
$sql = "SELECT id, awbnumber, price, datetime, status FROM manifests WHERE hub='Calamba' AND status='Delivered'";
$result = $conn->query($sql);

// Calculate total amount based on the same conditions
$total_sql = "SELECT SUM(price) AS total_amount FROM manifests WHERE hub='Calamba' AND status='Delivered'";
...
<body>
  <div class="sidebar">
    ...
    <a href="riderclmb_order.php">Order</a>
    <a class="active" href="riderclmb_remittance.php">Remittance</a>
