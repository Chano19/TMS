<?php
session_start();
if (!isset($_SESSION['email']) || $_SESSION['hub'] != 'Batangas' || $_SESSION['role'] != 'Staff') {
...
if ($search) {
	...
	$search_query = "WHERE hub LIKE 'Batangas' && role='Rider'";
}
...
<body>
  <div class="sidebar">
    ...
    <a class="active mt-3" href="batangashub.php"><i class="fas fa-home"></i> Home</a>
...
<div class="content">
	<div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="card">
            <button type="button" class="ords btn btn-info" onclick="location.href='batangashuborders.php'">
        ...
        <div class="col-md-6">
          <div class="card">
            <button type="button" class="rides btn btn-info active" onclick="location.href='batangasrider.php'">
