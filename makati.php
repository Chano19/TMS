...
if ($search) {
    ...
    $search_query = "WHERE customer_name LIKE '%$search%' OR awbnumber LIKE '%$search%' OR product_id LIKE '%$search%' AND hub LIKE 'Makati%'";
} else {
...
<section id="manifest">
    <h2 class="text-center p-5">List of Parcel in Makati</h2>
